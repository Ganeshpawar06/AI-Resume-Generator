...
if not GROQ_API_KEY:
    st.error("❌ GROQ_API_KEY missing. Add it to .streamlit/secrets.toml or environment variables.")
    st.stop()
...
st.markdown("""
****Powered by Groq Llama 3.3 70B** • Your all-in-one solution for job applications  
...
with col2:
    st.caption("st.caption("🔑 **API**: Groq")")
with col3:
    st.caption("📅 **Built**: Jan 2026 • Ganesh")
